...
<div id="wrapper">
  ...
  <div id="menu">
    <ul>
      <li><a href="http://all-free-download.com/free-website-templates/" class="active">RAVI</a></li>
...
<p id="demo"></p>
  ...
  <!-- end footer --><?php
$message = "HELLO Ravi!!!!Reliace industries has recently acceted your crop production and will con";
